...
<center><font face="Century Gothic" size="6"><b>Exclusão de Livros</b><font size = "4">
...
<form name ="livro" method="POST" action="">
    <fieldset id="a">
        ...
        <p>Cod Livro:<input name="txtid" type="text" size="20" maxlength="20" placeholder="Código do livro..">
        <br><br><center>
