...
<center><font face="Century Gothic" size="6"><b>Exclusão de Autores</b><font size = "4">
...
<form name ="autor" method="POST" action="">
    <fieldset id="a">
        ...
        <p>Cod Autor:<input name="txtid" type="text" size="20" maxlength="20" placeholder="Cod autor..">
        <br><br><center>
